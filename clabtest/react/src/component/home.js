...
function Home (){
    ...
    <body>
        ...
        <div class="about-section">
            ...
            <hr></hr>
            <p>CLAB employs artificial intelligence algorithms to detect notes and rhythms in audio files. The software analyzes the audio file and uses machine learning techniques to identify each note and the timing of each note. Once the software has identified the notes and rhythms, it creates a music notation file that the user can store, and share. The user can export the music notation file in a PDF format. CLAB is easy to use and provides accurate results, making it an indispensable tool for anyone looking to accelerate the process of creating music notation.</p>
        </div>
        </div>
