...
TAB_MAP = {
        ...
        Note("E", 0) : FretboardPosition(6, 6),
        Note("E", 0) : FretboardPosition(6, 7),
        Note("E", 0) : FretboardPosition(6, 8),
        Note("E", 0) : FretboardPosition(6, 9),
        Note("E", 0) : FretboardPosition(6, 10),
